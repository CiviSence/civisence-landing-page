...
const legalDocs = [
  {
    ...
    summary:
      "How we collect, use, and protect your account and civic reporting data.",
    path: "/privacy",
  ...
  },
  {
    ...
    summary:
      "The rules for using CiviSence and participating in civic issue workflows.",
    path: "/terms",
  ...
  },
  {
    ...
    summary:
      "Our approach to encryption, access control, and secure operations.",
    path: "/security",
  ...
  },
  {
    ...
    summary:
      "How we support accessible use of our platform and how to request help.",
    path: "/accessibility",
  ...
  },
  {
    ...
    title: "Cookie Policy",
    summary:
      "How cookies and similar technologies support your experience on CiviSence.",
    path: "/cookies",
  ...
  },
  {
    ...
    summary:
      "Standards for safe, respectful, and lawful use of the CiviSence platform.",
    path: "/acceptable-use",
  ...
  },
  {
    ...
    summary:
      "How we disclose and govern the use of AI features and automation.",
  ...
  },
  {
    ...
    summary:
      "How users can reach support and receive help with platform issues.",
  ...
  },
  {
    ...
    summary:
      "How we review, manage, and remove content that violates our rules.",
  ...
  },
  {
    ...
    summary:
      "How we handle intellectual property rights and reporting infringements.",
    path: "/copyright-ip",
  ...
  },
  {
    ...
    summary:
      "How you can request deletion of your personal data and related records.",
    path: "/data-deletion",
...
const getDocMetadata = (content) => {
  ...
  const effectiveMatch = content.match(
    /\*\*Effective Date:\*\*?\s*([^\n\r]+)/i,
  );
  return {
...
const LegalPage = ({ currentPath = "/privacy" }) => {
  ...
  const currentDoc =
    legalDocs.find((doc) => doc.slug === normalizedPath) || legalDocs[0];
  ...
  const nextDoc =
    docIndex < legalDocs.length - 1 ? legalDocs[docIndex + 1] : null;
      ...
      .map((doc) => {
        ...
        if (titleMatch || summaryMatch || contentMatch) {
          const snippet = contentMatch
            ? getSearchSnippet(doc.content, q)
            : doc.summary;
          return { ...doc, snippet };
        }
        return null;
  ...
  const cleanContent = currentDoc.content
    .trim()
    .replace(/^#\s+[^\n\r]+/, "")
    .trim();
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 404) {
          console.warn(
            "[CiviSence Dev] /api/compliance returned 404. Simulating compliance request database registration locally.",
          );
  ...
  return (
    <section
      className="bg-white min-h-screen py-16 font-sans relative"
        ...
        <div className="grid lg:grid-cols-[240px_1fr] xl:grid-cols-[240px_1fr_200px] gap-12">
            ...
            {searchQuery ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-zinc-100 pb-2 px-1">
                  ...
                  <button
                    onClick={() => setSearchQuery("")}
                    className="text-[10px] text-zinc-500 hover:text-zinc-900 font-semibold underline"
                  >
                    Clear
                  </button>
                </div>
          ...
          <article className="min-w-0 print-container">
            ...
            >
              ...
              <div className="relative">
                ...
                <div
                  className="watermark-overlay no-print"
                  aria-hidden="true"
                />
                ...
                <div className="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50/50 p-6 no-print space-y-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-bold text-zinc-900">
                      Compliance Request Assistant
                    </h4>
                    <p className="text-xs text-zinc-500">
                      Select details below to generate a preformatted regulatory
                      request draft.
                    </p>
                  </div>
                  ...
                  {complianceError && (
                    <div className="text-xs font-bold text-red-600 bg-red-50 border border-red-200 rounded-lg p-3">
                      ⚠ Database recording failed. You can still copy the draft
                      text manually.
                    </div>
                  )}
          ...
          <aside className="hidden xl:block w-50 sticky top-24 self-start max-h-[calc(100vh-120px)] overflow-y-auto pr-2 no-print space-y-8">
            ...
            <div className="space-y-2 text-[11px] text-zinc-400 leading-relaxed font-medium">
              <p className="font-bold text-zinc-800 uppercase tracking-wider text-[9px]">
                Need support?
              </p>
              <p>
                For questions or requests about these terms, reach our
                compliance team:
              </p>
              <div className="space-y-1">
                <a
                  href="mailto:civisence@gmail.com"
                  className="block text-zinc-600 hover:text-zinc-950 underline font-bold"
                >
                  civisence@gmail.com
                </a>
                <a
                  href="mailto:civisence@zohomail.in"
                  className="block text-zinc-600 hover:text-zinc-950 underline font-bold"
                >
